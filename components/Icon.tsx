...
import {
  ...
  Chrome, Compass, Info, Image, Download, UserCheck, FileText, Microscope, ClipboardList, MessageCircle, Share2, Trash2, Calendar, Plus, Filter, Eye as EyeIcon, Drill, Copy, Route, Timer
} from 'lucide-react';
