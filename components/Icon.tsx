...
import {
  ...
  Chrome, Compass, Info, Image, Download, UserCheck, FileText, Microscope, ClipboardList, MessageCircle, Share2, Trash2, Calendar, Plus, Filter, Eye as EyeIcon, Tooth
} from 'lucide-react';
...
export const Icon: React.FC<{ name: string; className?: string; size?: number }> = ({ name, className, size = 24 }) => {
  ...
  switch (name) {
    ...
    case 'tooth': return <Tooth {...iconProps} />;
