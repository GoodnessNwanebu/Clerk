    ...
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 max-w-sm w-full mx-4 shadow-2xl">
        ...
        <div className="flex space-x-3">
          <button
            onClick={onShare}
            className="flex-1 py-3 bg-gradient-to-r from-green-500 to-green-600 rounded-lg font-semibold text-white hover:scale-105 transform transition-transform flex items-center justify-center space-x-2"
          >
